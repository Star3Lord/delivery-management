    ...
    <div class="flex">
      {#each ['desktop', 'mobile'] as key (key)}
        ...
        <button
          ...
          class="relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-start even:border-s hover:bg-muted/50 data-[active=true]:bg-muted/50 sm:border-s sm:border-t-0 sm:px-8 sm:py-6"
